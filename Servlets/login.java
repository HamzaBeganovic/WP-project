    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (rs.next()) {
                    korisnici.setUsername(rs.getString("username"));
                    korisnici.setAddress(rs.getString("address"));
                    korisnici.setRole(rs.getShort("role"));
                    stmt.close();
                    session.setAttribute("user", korisnici);
                } else {
                    stmt.close();
